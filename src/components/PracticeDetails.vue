    ...
    <v-container grid-list-lg>
        ...
        >
            <v-flex>
                ...
                <p class="subheading mt-3">We also have thorough expertise in litigating cases 
                ...
                <p class="subheading mt-3">Also, in unique situations, Taylor Law Office handles 
